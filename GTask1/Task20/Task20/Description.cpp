...
/**
*@brief return rol number 
*@param unsigned long Number, unsigned long Shift
*@return unsigned long Result
*@warning max Shift value is 31
*/
unsigned long ROL (unsigned int Number, unsigned int Shift)
{
	
	unsigned long Result=0;
	Result=Number>>(MAX_SHIFT_VALUE-Shift);
	Result>>=1;
	Result=(Number<<Shift)|Result;
